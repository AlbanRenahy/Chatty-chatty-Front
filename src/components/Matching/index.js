...
// import data
import beerGif from '../../data/beer.gif';
import glassGif from '../../data/glass.gif';
import kidGif from '../../data/kid.gif';
...
class Matching extends Component {
  ...
  render () {
    ...
    <SwipeableList>
      <SwipeableListItem
        swipeLeft={{
          content:<Image roundedCircle className="right" src={glassGif} /> ,
          action: () => (
        ...
        <div className="card">
          ...
          {end &&
            <div className="card-special">
              ...
              <Image fluid roundedCircle className="right" src={kidGif} />
